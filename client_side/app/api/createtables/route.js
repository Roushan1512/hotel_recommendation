...
export const GET = async () => {
  try {
    ...
    const searches =
      "create table searches(id int auto_increment primary key, email varchar(255), name varchar(255), country varchar(255), sortBy int, stars int, fromNum int, toNum int, description varchar(255), created_at timestamp default current_timestamp);";
